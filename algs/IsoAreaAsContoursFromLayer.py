...
class IsoAreaAsContoursFromLayer(QgisAlgorithm):
    ...
    def shortHelpString(self):
        return  "<b>General:</b><br>"\
                ...
                "<ul><li>Network Layer</li><li>Startpoint Layer</li><li>Unique Point ID Field (numerical)</li><li>Maximum cost level of Iso-Area in distance (meters) or time (seconds)</li><li>Cost Intervals for Iso-Area Bands</li><li>Cellsize in Meters (increase default when analyzing larger networks)</li><li>Path type to calculate</li></ul><br>"\
