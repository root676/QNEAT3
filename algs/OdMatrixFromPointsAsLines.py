...
class OdMatrixFromPointsAsLines(QgisAlgorithm):
    ...
    def name(self):
        return 'OD Matrix from Points as Lines'
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        fields.append(QgsField('origin_id', output_id_field_data_type, '', 20, 0))
        fields.append(QgsField('destination_id', output_id_field_data_type, '', 20, 0))
